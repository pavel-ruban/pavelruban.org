 ...
 */
class EntityReference_SelectionHandler_Bean extends EntityReference_SelectionHandler_Generic implements EntityReference_SelectionHandler {
  ...
  public static function getInstance($field, $instance = NULL, $entity_type = NULL, $entity = NULL) {
    ...
    return new EntityReference_SelectionHandler_Bean($field, $instance, $entity_type, $entity);
  }
  ...
  protected function buildEntityFieldQuery($match = NULL, $match_operator = 'CONTAINS') {
    ...
    if (isset($match)) {
      ...
      if (isset($entity_info['entity keys']['label'])) {
        $query->propertyCondition('label', $match, $match_operator);
      }
    }
