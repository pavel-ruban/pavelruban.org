...
<div id='page-title'><div class='limiter clearfix'>
  <?php if (!empty($le_admin_menu_level_1)) :?>
    <div class="le-admin-menu-level-1">
      <?php print $le_admin_menu_level_1; ?>
    </div>
  <?php endif;?>
  <?php if (!empty($le_admin_menu_level_2)) :?>
    <div class="le-admin-menu-level-2">
      <?php print $le_admin_menu_level_2; ?>
    </div>
  <?php endif;?>
